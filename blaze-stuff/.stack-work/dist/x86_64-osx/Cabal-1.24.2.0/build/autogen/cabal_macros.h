...
/* package blaze-stuff-0.1.0.0 */
#define VERSION_blaze_stuff "0.1.0.0"
#define MIN_VERSION_blaze_stuff(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "blaze-stuff-0.1.0.0-KeX9L3GTUGsJVFaBJueO5g"

#define CURRENT_PACKAGE_KEY "blaze-stuff-0.1.0.0-KeX9L3GTUGsJVFaBJueO5g"
